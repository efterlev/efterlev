...
- **30 KSI-mapped detectors** evidence FRMR-Moderate KSIs directly. Together they cover **22 of 60 KSIs** at
  ...
  ≥30 KSIs.
- Detector sources: **35 from `terraform`** (read `.tf` files or `terraform show -json` output) +
