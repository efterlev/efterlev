...
| Demo target | `demo/govnotes/` — a synthetic gov-adjacent SaaS with deliberate gaps the agents exercise. Added as a git submodule pinned to [`lhassa8/govnotes-demo@0e33252`](https://github.com/lhassa8/govnotes-demo/commit/0e33252); populate on a fresh clone via `git submodule update --init demo/govnotes`. |
